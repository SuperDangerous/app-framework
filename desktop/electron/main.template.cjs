 ...
 * Generated by @episensor/app-framework
 *
 * This template provides:
 * - Main window creation with dev/production loading
 * - Backend process spawning and management
 * - Basic IPC handlers for app info and window controls
 * - macOS/Windows/Linux platform handling
 */
...
const VITE_DEV_SERVER_URL = 'http://localhost:{{WEB_PORT}}';
